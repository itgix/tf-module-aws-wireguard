...
| [aws_lb.wireguard](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lb) | resource |
| [aws_lb_listener.nlb_listener_51820](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lb_listener) | resource |
| [aws_lb_target_group.wireguard](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lb_target_group) | resource |
| [aws_lb_target_group_attachment.wireguard](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lb_target_group_attachment) | resource |
| [aws_security_group.wireguard_nlb_sg](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/security_group) | resource |
...
| [aws_lb.wireguard](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/lb) | data source |
...
|------|-------------|------|---------|:--------:|
| <a name="input_alb_request_idle_timeout"></a> [alb\_request\_idle\_timeout](#input\_alb\_request\_idle\_timeout) | The idle duration for the alb requests, in minutes. This value must be a multiple of 60 (60, 120, 180, 240, 300, or 360) | `number` | `60` | no |
...
| <a name="input_certificate_arn"></a> [certificate\_arn](#input\_certificate\_arn) | List of ARNs for additional SSL certificates | `string` | `""` | no |
...
| <a name="input_create_wireguard_sg"></a> [create\_wireguard\_sg](#input\_create\_wireguard\_sg) | Create WEB Security group | `bool` | `true` | no |
...
| <a name="input_env"></a> [env](#input\_env) | env name | `string` | `""` | no |
...
| <a name="input_nlb_sg_id"></a> [nlb\_sg\_id](#input\_nlb\_sg\_id) | The security group ID of the NLB | `string` | `""` | no |
| <a name="input_nlb_subnet_id"></a> [nlb\_subnet\_id](#input\_nlb\_subnet\_id) | The VPC Subnet ID for NLB to launch in | `string` | `null` | no |
...
| <a name="input_sg_windows_web_id"></a> [sg\_windows\_web\_id](#input\_sg\_windows\_web\_id) | Security group ID of the Web instance | `string` | `""` | no |
...
| <a name="output_wireguard_sg"></a> [wireguard\_sg](#output\_wireguard\_sg) | n/a |
<!-- END_TF_DOCS -->
